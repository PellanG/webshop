...
class UserDatabase
{
  ...
  function seedUsers()
  {
    if ($this->pdo->query("select * from users where email='pellan.gustafsson@hotmail.com'")->rowCount() == 0) {
      $userId = $this->auth->admin()->createUser("pellan.gustafsson@hotmail.com", "Hurra2024", "pellan.gustafsson@hotmail.com");
